...
all_product = soup.find('div', class_="big_grid row form-row row-cols-1 row-cols-sm-2 row-cols-xl-3 row-cols-xxl-4")

products = all_product.find_all("div", class_="product-name")
